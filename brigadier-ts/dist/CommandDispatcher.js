...
var CommandDispatcher = /** @class */ (function () {
    ...
    CommandDispatcher.prototype.parse = function (reader, source) {
        ...
        var context = new internal_1.CommandContextBuilder(this, source, this.root, reader.getCursor());
    ...
    CommandDispatcher.prototype.parseNodes = function (node, originalReader, contextSoFar) {
        ...
        for (var _i = 0, _a = node.getRelevantNodes(originalReader); _i < _a.length; _i++) {
            ...
            var reader = new internal_1.StringReader(originalReader);
            try {
                try {
            ...
            if (reader.canRead(child.getRedirect() === null ? 2 : 1)) {
                ...
                if (child.getRedirect()) {
                    var childContext = new internal_1.CommandContextBuilder(this, source, child.getRedirect(), reader.getCursor());
                ...
                switch (_b.label) {
                    case 0:
                        ...
                        for (_i = 0, _a = parent.getChildren(); _i < _a.length; _i++) {
                            node = _a[_i];
                            promise = internal_1.Suggestions.empty();
                            try {
                    ...
                    case 1:
                        suggestions = _b.sent();
                        return [2 /*return*/, internal_1.Suggestions.merge(fullInput, suggestions)];
                }
            });
        });
    };
