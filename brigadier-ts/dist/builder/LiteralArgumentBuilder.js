...
var LiteralArgumentBuilder = /** @class */ (function (_super) {
    ...
    LiteralArgumentBuilder.prototype.build = function () {
        var result = new internal_1.LiteralCommandNode(this.getLiteral(), this.getCommand(), this.getRequirement(), this.getRedirect(), this.getRedirectModifier(), this.isFork());
