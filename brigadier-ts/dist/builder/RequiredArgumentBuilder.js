...
var RequiredArgumentBuilder = /** @class */ (function (_super) {
    ...
    RequiredArgumentBuilder.prototype.build = function () {
        var result = new internal_1.ArgumentCommandNode(this.getName(), this.getType(), this.getCommand(), this.getRequirement(), this.getRedirect(), this.getRedirectModifier(), this.isFork());
